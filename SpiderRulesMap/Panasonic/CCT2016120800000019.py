"""
    @description:   来源:松下
                    ...
                    目标类目:片式电阻器（低电阻型
                    商城类目:电流传感电阻器-SMD
                    来源网址:https://industrial.panasonic.cn/ea/products/resistors/chip-resistors/chip-resistors/current-sensing-resistors-thick-film-type?reset=1
    @author:        RoyalClown
    @date:          2016/12/12
"""
from DataAnalyse.dbDataGet.Panasonic_data import DataProcessing
from Spider.Panasonic.CurrentSensingResistorsThickFilmType.saveAndGo import all_go
...
class CCT2016120800000019:
    def __init__(self):
        self.task_code = "CCT2016120800000019"
