"""
    @description:   来源:松下官网
                    商城品牌:松下
                    目标类目:导电性聚合物钽固体电解电容器 (POSCAP) >
                    商城类目:导电性聚合物钽固体电解电容器
                    来源网址:https://industrial.panasonic.cn/ea/products/capacitors/polymer-capacitors/poscap#quicktabs-line_up_page_tab=1
    @author:        RoyalClown
    @date:          2016/12/9
"""
from DataAnalyse.dbDataGet.Panasonic_data import DataProcessing
from Spider.Panasonic.POSCAP.saveAndGo import all_go
...
class CCT2016120100000009:
    def __init__(self):
        self.task_code = "CCT2016120100000009"
