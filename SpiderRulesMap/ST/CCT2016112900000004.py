"""
    @description:   来源:ST官网
                    商城品牌:意法半导体
                    目标类目:Brushless DC Motor Drivers
                    商城类目:马达/运动/点火控制器和驱动器
                    来源网址:http://www.st.com/en/motor-drivers/brushless-dc-motor-drivers.html?querycriteria=productId=SC2130
    @author:        RoyalClown
    @date:          2016/11/30
"""
from DataAnalyse.dbDataGet.ST_data import DataProcessing
from Spider.ST.BrushlessDCMotorDrivers.saveAndGo import all_go
...
class CCT2016112900000004:
    def __init__(self):
        self.url = "http://www.st.com/en/motor-drivers/brushless-dc-motor-drivers.html?querycriteria=productId=SC2130"
        self.task_code = "CCT2016112900000004"
