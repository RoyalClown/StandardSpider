...
def db_save(product, task_code, task_id):
    ...
    component = detail_attributes.get_component(kiname="耐电涌片式电阻器/耐脉冲片式电阻器",
...
def all_go(task_code, task_id,
           url="https://industrial.panasonic.cn/ea/products/resistors/chip-resistors/chip-resistors/anti-surge-anti-pulse-high-power-thick-film-chip-resistors?reset=1&limit=100"):
