"""
    @description:   来源:松下
                    ...
                    目标类目:电阻电路中的片式电阻电路
                    商城类目:电阻器网络与阵列
                    来源网址:https://industrial.panasonic.cn/ea/products/resistors/resistor-network-array/resistor-network-array/chip-resistor-networks?reset=1
    @author:        RoyalClown
    @date:          2016/12/15
"""
from DataAnalyse.dbDataGet.Panasonic_data import DataProcessing
from Spider.Panasonic.ChipResistorNetworks.saveAndGo import all_go
...
class CCT2016121400000037:
    def __init__(self):
        self.task_code = "CCT2016121400000037"
