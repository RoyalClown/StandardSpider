"""
    @description:   来源:英飞凌官网
                    商城品牌:英飞凌
                    目标类目:800V CoolMOS™ N-Channel Power MOSFET
                    商城类目:金属氧化物半导体场效应管-MOSFET
                    来源网址:http://www.infineon.com/cms/cn/product/power/power-mosfet/500v-900v-n-channel-coolmos-power-mosfet/800v-coolmos-n-channel-power-mosfet/channel.html?channel=db3a304344921d300144ac590b4c7c63
    @author:        RoyalClown
    @date:          2016/12/9
"""
from Spider.Infineon.CoolMOSN_ChannelPowerMOSFET800V.saveAndGo import all_go
...
class CCT2016120900000002:
    def __init__(self):
        self.task_code = "CCT2016120900000002"
