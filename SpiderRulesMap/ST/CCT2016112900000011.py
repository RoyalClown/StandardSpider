"""
    @description:   来源:ST官网
                    商城品牌:意法半导体
                    目标类目:Stepper Motor Drivers
                    商城类目:马达/运动/点火控制器和驱动器
                    来源网址:http://www.st.com/en/motor-drivers/stepper-motor-drivers.html?querycriteria=productId=SC2132
    @author:        RoyalClown
    @date:          2016/11/30
"""
from DataAnalyse.dbDataGet.ST_data import DataProcessing
from Spider.ST.StepperMotorDrivers.saveAndGo import all_go
...
class CCT2016112900000011:
    def __init__(self):
        self.url = "http://www.st.com/en/motor-drivers/stepper-motor-drivers.html?querycriteria=productId=SC2132"
        self.task_code = "CCT2016112900000011"
