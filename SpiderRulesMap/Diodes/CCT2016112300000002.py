"""
    @description:   来源:diodes
                    商城品牌:达尔
                    目标类目:Pre-Bias Transistors
                    商城类目:预偏置晶体管
                    来源网址:http://www.diodes.com/catalog/Pre-Bias_Transistors_116
    @author:        RoyalClown
    @date:          2016/11/23
"""
...
from Spider.Diodes.Pre_Bias_Transistors.saveAndGo import all_go


class CCT2016112300000002:
    def __init__(self):
        self.url = "http://www.rohm.com.cn/web/china/search/parametric/-/search/Multi-Output%20LDO%20Regulators"
        self.task_code = "CCT2016112300000002"
