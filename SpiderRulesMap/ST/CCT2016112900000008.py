"""
    @description:   来源:ST官网
                    商城品牌:意法半导体
                    目标类目:Counters/Encoders/Decoders
                    商城类目:编码器、解码器、复用器和解复用器
                    来源网址:http://www.st.com/en/automotive-logic-ics/counters-encoders-decoders.html?querycriteria=productId=SC1850
    @author:        RoyalClown
    @date:          2016/11/30
"""
from DataAnalyse.dbDataGet.ST_data import DataProcessing
from Spider.ST.CountersEncodersDecoders.saveAndGo import all_go
...
class CCT2016112900000008:
    def __init__(self):
        self.url = "http://www.st.com/en/automotive-logic-ics/counters-encoders-decoders.html?querycriteria=productId=SC1850"
        self.task_code = "CCT2016112900000008"
