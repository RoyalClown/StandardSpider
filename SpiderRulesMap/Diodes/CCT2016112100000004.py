"""
    @description:   来源:diodes
                    商城品牌:达尔
                    目标类目:MOSFET Master Table
                    商城类目:金属氧化物半导体场效应管-MOSFET
                    来源网址:http://www.diodes.com/catalog/MOSFET_Master_Table_98
    @author:        RoyalClown
    @date:          2016/11/23
"""
...
from Spider.Diodes.MOSFET_Master_Table.saveAndGo import all_go


class CCT2016112100000004:
    def __init__(self):
        self.url = "http://www.rohm.com.cn/web/china/search/parametric/-/search/Multi-Output%20LDO%20Regulators"
        self.task_code = "CCT2016112100000004"
