"""
    @description:   来源:ST官网
                    ...
                    目标类目:LVDS
                    商城类目:LVDS接口集成电路
                    来源网址:http://www.st.com/en/interfaces-and-transceivers/lvds.html?querycriteria=productId=SC395
    @author:        RoyalClown
    @date:          2016/11/30
"""
from DataAnalyse.dbDataGet.ST_data import DataProcessing
from Spider.ST.LVDS.saveAndGo import all_go
...
class CCT2016112900000019:
    def __init__(self):
        self.url = "http://www.st.com/en/interfaces-and-transceivers/lvds.html?querycriteria=productId=SC395"
        self.task_code = "CCT2016112900000019"
