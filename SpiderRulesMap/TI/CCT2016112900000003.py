"""
    @description:   来源:德州仪器官网
                    商城品牌:德州仪器
                    目标类目:LDO 控制器（外部 FET） 产品
                    商城类目:低压差线性稳压器
                    来源网址:http://www.ti.com.cn/lsds/ti_zh/power-management/ldo-controller-external-fet-products.page
    @author:        RoyalClown
    @date:          2016/12/12
"""
from Spider.TI.LdoControllerExternalFet.saveAndGo import all_go
...
class CCT2016112900000003:
    def __init__(self):
        self.task_code = "CCT2016112900000003"
