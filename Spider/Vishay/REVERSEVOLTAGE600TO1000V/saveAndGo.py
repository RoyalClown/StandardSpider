...
from Spider.Vishay.REVERSEVOLTAGE600TO1000V.productList import Detail, ProductList


def db_save(rough_product, task_code, task_id):
    detail_attributes = Detail(rough_product)
