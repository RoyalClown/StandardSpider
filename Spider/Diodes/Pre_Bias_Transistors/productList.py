...
class ProductList:
    def __init__(self, url="http://www.diodes.com/catalog/Pre-Bias_Transistors_116"):
        self.url = url

    def get_product_list(self):
        res = requests.post("http://www.diodes.com/api/catalog/116/products")
