...
class ProductList:
    def __init__(self,
                 url="http://www.st.com/en/motor-drivers/igbt-and-mosfet-drivers.html?querycriteria=productId=SC2095"):
        self.url = url

    def get_product_list(self):
        res = requests.get(
            "http://www.st.com/content/st_com/en/products/amplifiers-and-comparators/comparators/standard-comparators.product-grid.html/SC2095.json")
...
class Detail:
    ...
    def get_component(self):
        ...
        kiname = "IGBT and MOSFET Drivers"
