...
def all_go(task_code, task_id, url="https://industrial.panasonic.cn/ea/products/resistors/chip-resistors/chip-resistors/thin-film-chip-resistors-high-reliability-type?reset=1&limit=100"):
