"""
    @description:   来源:atmel官网
                    商城品牌:爱特梅尔
                    目标类目:Parallel EEPROM（爬取订购码）
                    商城类目:电可擦可编程只读存储器-EEPROM
                    来源网址:http://www.atmel.com/devices/AT28C010.aspx
    @author:        RoyalClown
    @date:          2016/11/25
"""
...
from Spider.Atmel.ParallelEEprom.saveAndGo import all_go


class CCT2016112400000002:
    def __init__(self):
        self.url = "http://www.atmel.com/devices/AT28C010.aspx"
        self.task_code = "CCT2016112400000002"
