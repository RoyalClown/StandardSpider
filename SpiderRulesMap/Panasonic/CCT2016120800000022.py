"""
    @description:   来源:松下
                    ...
                    目标类目:片式电阻器（精密级型）
                    商城类目:通用型电阻
                    来源网址:https://industrial.panasonic.cn/ea/products/resistors/chip-resistors/chip-resistors/precision-thick-film-chip-resistors?reset=1
    @author:        RoyalClown
    @date:          2016/12/14
"""
from DataAnalyse.dbDataGet.Panasonic_data import DataProcessing
from Spider.Panasonic.PrecisionThickFilmChipResistors.saveAndGo import all_go
...
class CCT2016120800000022:
    def __init__(self):
        self.task_code = "CCT2016120800000022"
