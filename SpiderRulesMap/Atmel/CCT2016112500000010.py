"""
    @description:   来源:atmel官网
                    商城品牌:爱特梅尔
                    目标类目:Serial EEPROM – SPI（爬取订购码）
                    商城类目:电可擦可编程只读存储器-EEPROM
                    来源网址:http://www.atmel.com/products/memories/serial/spi.aspx
    @author:        RoyalClown
    @date:          2016/11/25
"""
...
from Spider.Atmel.Serial_EEPROM.saveAndGo import all_go


class CCT2016112500000010:
    def __init__(self):
        self.url = "http://www.atmel.com/products/memories/serial/spi.aspx"
        self.task_code = "CCT2016112500000010"
