...
def all_go(task_code, task_id, url="https://industrial.panasonic.cn/ea/products/sensors/built-in-sensors/grid-eye#quicktabs-line_up_page_tab=1"):
    product_list = ProductList()
    series_urls = product_list.get_series_urls(url)
    for series_url in series_urls:
        db_save(series_url, task_code, task_id)
