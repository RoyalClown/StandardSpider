...
def db_save(product, task_code, task_id):
    ...
    component = detail_attributes.get_component(kiname="耐硫化片式电阻器",
                                                attach="https://industrial.panasonic.cn/cdbs/www-data/pdf/RDA0000/AOA0000C129.pdf",
                                                img="https://industrial.panasonic.cn/cdbs/www-data/gif/RDA0000/AOA0000SC87.gif")
    try:
...
def all_go(task_code, task_id,
           url="https://industrial.panasonic.cn/ea/products/resistors/chip-resistors/chip-resistors/anti-sulfurated-thick-film-chip-resistors?reset=1&limit=100"):
