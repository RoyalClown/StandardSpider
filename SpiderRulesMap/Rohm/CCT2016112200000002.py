"""
    @description:   来源:ROHM
                    ...
                    目标类目:单输出低饱和稳压器(LDO)
                    商城类目:低压差线性稳压器
                    来源网址:http://www.rohm.com.cn/web/china/search/parametric/-/search/Single-Output%20LDO%20Regulators
    @author:        RoyalClown
    @date:          2016/11/22
"""
from Spider.Rohm.VoltageRegulator.Single_Output_LDO.saveAndGo import all_go
...
class CCT2016112200000002:
    def __init__(self):
        self.url = "http://www.rohm.com.cn/web/china/search/parametric/-/search/Single-Output%20LDO%20Regulators"
        self.task_code = "CCT2016112200000002"
