...
class ProductList:
    def __init__(self,
                 url="http://www.st.com/en/automotive-logic-ics/counters-encoders-decoders.html?querycriteria=productId=SC1850"):
        self.url = url

    def get_product_list(self):
        res = requests.get(
            "http://www.st.com/content/st_com/en/products/amplifiers-and-comparators/comparators/standard-comparators.product-grid.html/SC1850.json")
...
class Detail:
    ...
    def get_component(self):
        ...
        kiname = "Counters/Encoders/Decoders"
