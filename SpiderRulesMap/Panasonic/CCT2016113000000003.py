"""
    @description:   来源:松下官网
                    ...
                    目标类目:薄膜电容器 (电子机器用)
                    商城类目:薄膜电容器
                    来源网址:https://industrial.panasonic.cn/ea/products/capacitors/film-capacitors/film-cap-electroequip#quicktabs-line_up_page_tab=1
    @author:        RoyalClown
    @date:          2016/12/6
"""
from Spider.Panasonic.FilmCapacitors.saveAndGo import all_go
...
class CCT2016113000000003:
    def __init__(self):
        self.task_code = "CCT2016113000000003"
