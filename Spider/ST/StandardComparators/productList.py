...
class Detail:
    ...
    def get_attributes(self):
        ...
        attributes_list = ["Part Number", "General Description", "Marketing Status", "Fabrication Technology","Package","Automotive Grade", "Number of Channels", "Operating Temperature (°C)min", "Operating Temperature (°C)max"
                           "Supply Voltage (V)min", "Supply Voltage (V)max", "Vi Range",
                           ]
        many_attributes = []
