...
from Spider.Panasonic.MetalFilmFusingResistor.listProducts import ProductList, Detail


def db_save(product, task_code, task_id):
    detail_attributes = Detail(product)
    component = detail_attributes.get_component(kiname="金属覆膜熔断电阻器",
                                                attach="https://industrial.panasonic.cn/cdbs/www-data/pdf/RDB0000/AOB0000C12.pdf",
                                                img="https://industrial.panasonic.cn/cdbs/www-data/gif/RDB0000/AOB0000SC3.gif")
    try:
