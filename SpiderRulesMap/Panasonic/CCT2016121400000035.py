"""
    @description:   来源:松下
                    商城品牌:松下
                    目标类目:电阻电路中的耐硫化多连片式电阻器
                    商城类目:电阻器网络与阵列
                    来源网址:https://industrial.panasonic.cn/ea/products/resistors/resistor-network-array/resistor-network-array/anti-sulfurated-chip-resistor-array?reset=1
    @author:        RoyalClown
    @date:          2016/12/14
"""
from DataAnalyse.dbDataGet.Panasonic_data import DataProcessing
from Spider.Panasonic.AntiSulfuratedChipResistorArray.saveAndGo import all_go
...
class CCT2016121400000035:
    def __init__(self):
        self.task_code = "CCT2016121400000035"
