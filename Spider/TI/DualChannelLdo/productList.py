...
class ProductList:
    def __init__(self,
                 url="http://www.ti.com.cn/lsds/ti_zh/power-management/dual-channel-ldo-products.page"):
        self.url = url

    def get_product_list(self):
        html_analyse = HtmlAnalyse("http://www.ti.com.cn/wsapi/paramdata/family/660/results?lang=cn&output=json")
