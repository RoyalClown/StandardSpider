"""
    @description:   来源:松下
                    ...
                    目标类目:厚膜高精度贴片电阻器
                    商城类目:精密级电阻
                    来源网址:https://industrial.panasonic.cn/ea/products/resistors/chip-resistors/chip-resistors/high-precision-thick-film-chip-resistors?reset=1
    @author:        RoyalClown
    @date:          2016/12/14
"""
from DataAnalyse.dbDataGet.Panasonic_data import DataProcessing
from Spider.Panasonic.HighPrecisionThickFilmChipResistors.saveAndGo import all_go
...
class CCT2016120900000004:
    def __init__(self):
        self.task_code = "CCT2016120900000004"
