...
class ProductList:
    ...
    def get_product_list(self):
        ...
        data = {"Category_Radio": "Rchip", "Feature_Radio": "Rchip_RFAtten", "CATEGORY": "Rchip",
                "FEATURE": "Rchip_RFAtten", "INDUCTANCE": "", "TOLERANCE": "", "IMPEDANCE": "", "SIZE": "",
                "POWER": "",
...
if __name__ == "__main__":
    ...
    with open("../CCT2017011600000038.csv", "w", encoding="utf-8") as f:
        f.write(
