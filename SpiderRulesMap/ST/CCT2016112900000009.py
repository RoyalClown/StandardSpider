"""
    @description:   来源:ST官网
                    商城品牌:意法半导体
                    目标类目:Buffers/drivers
                    商城类目:缓冲器和线路驱动器
                    来源网址:http://www.st.com/en/automotive-logic-ics/buffers-drivers.html?querycriteria=productId=SC1797
    @author:        RoyalClown
    @date:          2016/11/30
"""
from DataAnalyse.dbDataGet.ST_data import DataProcessing
from Spider.ST.Buffersdrivers.saveAndGo import all_go
...
class CCT2016112900000009:
    def __init__(self):
        self.url = "http://www.st.com/en/automotive-logic-ics/buffers-drivers.html?querycriteria=productId=SC1797"
        self.task_code = "CCT2016112900000009"
