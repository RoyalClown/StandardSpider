"""
    @description:   来源:ST官网
                    商城品牌:意法半导体
                    目标类目:Automotive Comparators
                    商城类目:模拟比较器
                    来源网址:http://www.st.com/en/amplifiers-and-comparators/automotive-comparators.html?querycriteria=productId=SS1616
    @author:        RoyalClown
    @date:          2016/11/30
"""
from DataAnalyse.dbDataGet.ST_data import DataProcessing
from Spider.ST.AutomotiveComparators.saveAndGo import all_go
