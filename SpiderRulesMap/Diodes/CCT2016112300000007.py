"""
    @description:   来源:Diode
                    商城品牌:达尔
                    目标类目:Dual LDOs
                    商城类目:低压差线性稳压器
                    来源网址:http://www.diodes.com/catalog/Dual_LDOs_51
    @author:        RoyalClown
    @date:          2016/11/24
"""
from DataAnalyse.dbDataGet.CCT2016112300000007_data import DataProcessing
...
from Spider.Diodes.Dual_LDOs.saveAndGo import all_go


class CCT2016112300000007:
    def __init__(self):
        self.url = "http://www.rohm.com.cn/web/china/search/parametric/-/search/Multi-Output%20LDO%20Regulators"
        self.task_code = "CCT2016112300000007"
