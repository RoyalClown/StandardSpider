"""
    @description:   来源:松下
                    ...
                    目标类目:金属覆膜熔断电阻器
                    商城类目:金属膜电阻-通孔
                    来源网址:https://industrial.panasonic.cn/ea/products/resistors/fusing-resistors/fusing-resistors/metal-film-fusing-resistor/ERQ12AJ100
    @author:        RoyalClown
    @date:          2016/12/14
"""
from DataAnalyse.dbDataGet.Panasonic_data import DataProcessing
from Spider.Panasonic.MetalFilmFusingResistor.saveAndGo import all_go
...
class CCT2016120900000016:
    def __init__(self):
        self.task_code = "CCT2016120900000016"
