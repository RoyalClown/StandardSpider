"""
    @description:   来源:意法半导体
                    商城品牌:意法半导体
                    目标类目:Gates
                    商城类目:逻辑门
                    来源网址:http://www.st.com/content/st_com/en/products/automotive-logic-ics/gates.html?querycriteria=productId=SC1799
    @author:        RoyalClown
    @date:          2016/11/29
"""
...
class CCT2016112900000007:
    def __init__(self):
        self.url = "http://www.st.com/content/st_com/en/products/automotive-logic-ics/gates.html?querycriteria=productId=SC1799"
        self.task_code = "CCT2016112900000007"
