...
class CCT2016110400000004:
    def __init__(self):
        self.url = "https://industrial.panasonic.cn/ea/products/capacitors/aluminum-capacitors/aluminum-cap-smd#quicktabs-line_up_page_tab=1"
        self.task_code = "CCT2016110400000004"
        # task_id=24
