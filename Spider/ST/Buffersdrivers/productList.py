...
class ProductList:
    def __init__(self,
                 url="http://www.st.com/en/automotive-logic-ics/buffers-drivers.html?querycriteria=productId=SC1797"):
        self.url = url

    def get_product_list(self):
        res = requests.get(
            "http://www.st.com/content/st_com/en/products/amplifiers-and-comparators/comparators/standard-comparators.product-grid.html/SC1797.json")
