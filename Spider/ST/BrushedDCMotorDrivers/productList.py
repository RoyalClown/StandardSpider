...
class ProductList:
    def __init__(self,
                 url="http://www.st.com/en/motor-drivers/brushed-dc-motor-drivers.html?querycriteria=productId=SC2131"):
        self.url = url

    def get_product_list(self):
        res = requests.get(
            "http://www.st.com/content/st_com/en/products/amplifiers-and-comparators/comparators/standard-comparators.product-grid.html/SC2131.json")
...
class Detail:
    ...
    def get_component(self):
        ...
        kiname = "Brushed DC Motor Drivers"
