"""
    @description:   来源:Diode
                    ...
                    目标类目:Single LDOs
                    商城类目:低压差线性稳压器
                    来源网址:http://www.diodes.com/catalog/Single_LDOs_50
    @author:        RoyalClown
    @date:          2016/11/23
"""
...
from Spider.Diodes.Single_LDOs.saveAndGo import all_go


class CCT2016112300000006:
    def __init__(self):
        self.url = "http://www.diodes.com/catalog/Single_LDOs_50"
        self.task_code = "CCT2016112300000006"
