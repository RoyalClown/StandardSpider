"""
    @description:   来源:ST官网
                    商城品牌:意法半导体
                    目标类目:High-Speed Comparators
                    商城类目:模拟比较器
                    来源网址:http://www.st.com/en/amplifiers-and-comparators/high-speed-comparators.html?querycriteria=productId=SS1615
    @author:        RoyalClown
    @date:          2016/11/30
"""
from DataAnalyse.dbDataGet.ST_data import DataProcessing
from Spider.ST.HighSpeedComparators.saveAndGo import all_go
...
class CCT2016112500000015:
    def __init__(self):
        self.url = "http://www.st.com/en/amplifiers-and-comparators/high-speed-comparators.html?querycriteria=productId=SS1615"
        self.task_code = "CCT2016112500000015"
