...
class ProductList:
    def __init__(self,
                 url="http://www.st.com/en/interfaces-and-transceivers/lvds.html?querycriteria=productId=SC395"):
        self.url = url

    def get_product_list(self):
        res = requests.get(
            "http://www.st.com/content/st_com/en/products/amplifiers-and-comparators/comparators/standard-comparators.product-grid.html/SC395.json")
