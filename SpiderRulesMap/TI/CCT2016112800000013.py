"""
    @description:   来源:德州仪器官网
                    ...
                    目标类目:单通道 LDO 产品
                    商城类目:低压差线性稳压器
                    来源网址:http://www.ti.com.cn/lsds/ti_zh/power-management/single-channel-ldo-products.page?
    @author:        RoyalClown
    @date:          2016/12/6
"""
from Spider.TI.SingleChannelLdo.saveAndGo import all_go
...
class CCT2016112800000013:
    def __init__(self):
        self.task_code = "CCT2016112800000013"
