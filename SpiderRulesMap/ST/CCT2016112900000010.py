"""
    @description:   来源:ST官网
                    商城品牌:意法半导体
                    目标类目:FlipFlop/registers
                    商城类目:触发器
                    来源网址:http://www.st.com/en/automotive-logic-ics/flipflop-registers.html?querycriteria=productId=SC1798
    @author:        RoyalClown
    @date:          2016/11/30
"""
from DataAnalyse.dbDataGet.ST_data import DataProcessing
from Spider.ST.FlipFlopregisters.saveAndGo import all_go
...
class CCT2016112900000010:
    def __init__(self):
        self.url = "http://www.st.com/en/automotive-logic-ics/flipflop-registers.html?querycriteria=productId=SC1798"
        self.task_code = "CCT2016112900000010"
