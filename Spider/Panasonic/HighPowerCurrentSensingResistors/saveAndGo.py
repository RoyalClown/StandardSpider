...
def all_go(task_code, task_id, url="https://industrial.panasonic.cn/ea/products/resistors/chip-resistors/chip-resistors/high-power-current-sensing-resistors-wide-terminal-type?reset=1&limit=100"):
