"""
    @description:   来源:英飞凌官网
                    商城品牌:英飞凌
                    目标类目:500V CoolMOS™ N-Channel Power MOSFET
                    商城类目:金属氧化物半导体场效应管-MOSFET
                    来源网址:http://www.infineon.com/cms/cn/product/power/power-mosfet/500v-900v-n-channel-coolmos-power-mosfet/500v-coolmos-n-channel-power-mosfet/channel.html?channel=5546d4624e765da5014ecef53832495d
    @author:        RoyalClown
    @date:          2016/12/9
"""
from Spider.Infineon.CoolMOSN_ChannelPowerMOSFET500V.saveAndGo import all_go
...
class CCT2016112800000003:
    def __init__(self):
        self.task_code = "CCT2016112800000003"
