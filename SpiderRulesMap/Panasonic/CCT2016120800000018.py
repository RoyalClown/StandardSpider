"""
    @description:   来源:松下
                    ...
                    目标类目:大功率片式电阻器（长边电极型）
                    商城类目:电流传感电阻器-SMD
                    来源网址:https://industrial.panasonic.cn/ea/products/resistors/chip-resistors/chip-resistors/high-power-current-sensing-resistors-wide-terminal-type?reset=1
    @author:        RoyalClown
    @date:          2016/12/6
"""
from DataAnalyse.dbDataGet.Panasonic_data import DataProcessing
from Spider.Panasonic.HighPowerCurrentSensingResistors.saveAndGo import all_go
...
class CCT2016120800000018:
    def __init__(self):
        self.task_code = "CCT2016120800000018"
