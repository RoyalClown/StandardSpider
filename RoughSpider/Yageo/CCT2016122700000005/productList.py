...
class ProductList:
    ...
    def get_product_list(self):
        ...
        data = {"Category_Radio": "Ecap", "Feature_Radio": "Ecap_SurfaceMount", "CATEGORY": "Ecap",
                "FEATURE": "Ecap_SurfaceMount", "INDUCTANCE": "", "TOLERANCE": "", "IMPEDANCE": "", "SIZE": "",
                "POWER": "",
...
if __name__ == "__main__":
    ...
    with open("../CCT2017011100000005.csv", "w", encoding="utf-8") as f:
        f.write(
            "pdf, Part No.,Series Name,Voltage,Tolerance,Capacitance,Pitch,Case Size\n")
