"""
    @description:   来源:ST官网
                    商城品牌:意法半导体
                    目标类目:Smartcard Interfaces
                    商城类目:智能接口
                    来源网址:http://www.st.com/en/interfaces-and-transceivers/smartcard-interfaces.html?querycriteria=productId=SC1620
    @author:        RoyalClown
    @date:          2016/11/30
"""
from DataAnalyse.dbDataGet.ST_data import DataProcessing
from Spider.ST.SmartcardInterfaces.saveAndGo import all_go
...
class CCT2016120100000012:
    def __init__(self):
        self.url = "http://www.st.com/en/interfaces-and-transceivers/smartcard-interfaces.html?querycriteria=productId=SC1620 "
        self.task_code = "CCT2016120100000012"
